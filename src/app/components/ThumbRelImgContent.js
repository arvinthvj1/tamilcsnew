    ...
    <>
     <Image
      style={{ display: isDomLoaded ? "block" : "none" }}
        ...
        <div style={{ width: "192px", height : "144px" }} class="flex items-center justify-center bg-gray-300 rounded-t-lg  md:rounded-none md:rounded-s-lg dark:bg-gray-700">
